...
messageForm.addEventListener('submit', function(event) {    //
    ...
    newMessage.innerHTML = `<a href='mailto:${email}'>${name}</a> <span> wrote: ${message}</span> <button class = "submit" id = "remove" type = "button"> remove </button>`;    //remove란 버튼 생성
    ...
    const removeButton = document.querySelector('form[name="li"]');
